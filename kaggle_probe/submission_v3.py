...
WEAKEST_ENEMY_VALUE_MULT_2P = 1.35  # ↑
GANG_UP_VALUE_MULT = 1.75           # ↑ 1.4→1.75
GANG_UP_POST_BATTLE_DELAY = 2       # turns after battle to arrive
GANG_UP_ETA_WINDOW = 6              # ↑ 4→6

# NEW L3: competition pressure — 竞争压力折扣
COMPETITION_PRESSURE_HARD = 0.28     # 敌方比我早4+回合到达
COMPETITION_PRESSURE_SOFT = 0.62     # 敌方比我早1-3回合到达
# NEW L3: high-production planet compounding bonus
HIGH_PROD_BONUS_THRESHOLD = 3        # production 超过此值触发加成
HIGH_PROD_BONUS_PER_POINT = 0.12     # 每超1点加12%
# NEW L5: production-deficit urgency
PROD_BEHIND_NEUTRAL_MULT = 1.18      # 产量落后时抢中立星奖励
...
SOFT_ACT_DEADLINE = 0.88            # ↑ 0.82→0.88 多用计算时间
...
def build_modes(world):
    ...
    return {
        ...
        "is_prod_behind": is_prod_behind,   # NEW
        "prod_ratio": prod_ratio,           # NEW
