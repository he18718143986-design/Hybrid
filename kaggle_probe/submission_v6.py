...
# v6-minimal: v2 + competition/high-prod/prod-behind heuristics
...
FOUR_PLAYER_ROTATING_SEND_RATIO = 0.62  # v6: slightly more 4P opening commit
...
COMPETITION_PRESSURE_HARD = 0.28     # enemy arrives 4+ turns before us
COMPETITION_PRESSURE_SOFT = 0.62     # enemy arrives 1-3 turns before us
HIGH_PROD_BONUS_THRESHOLD = 3        # production above this gets extra value
HIGH_PROD_BONUS_PER_POINT = 0.12     # 12% per production point above threshold
PROD_BEHIND_NEUTRAL_MULT = 1.18      # extra incentive to grab neutrals when behind
...
MULTI_ENEMY_PROACTIVE_RATIO = 0.28  # v6: less 4P defensive lock-up
